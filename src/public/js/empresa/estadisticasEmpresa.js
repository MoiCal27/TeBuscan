...
export async function cargarEstadisticas() {
  try {
    ...
    document.getElementById("stat-empleos-activos").textContent =
      estadisticas.empleosActivos;
    document.getElementById("stat-total-aplicaciones").textContent =
      estadisticas.totalAplicaciones;
    document.getElementById("stat-visitas").textContent =
      estadisticas.visitasPerfil.toLocaleString();
    document.getElementById("stat-valoracion").textContent =
      estadisticas.valoracionPromedio;
    document.getElementById("stat-total-valoraciones").textContent =
      `${estadisticas.totalValoraciones} opiniones`;
