            ...
            <div class="d-flex align-items-start gap-3">
                ...
                <div class="flex-grow-1">
                    ...
                    <a href="#"
                       ...
                       onclick="abrirModalRecurso(event, '${r.titulo_recurso.replace(/'/g, "\\'")}')">
                        Leer más →
                    </a>
                </div>
            </div>
...
function mostrarCargando() {
    ...
    lista.innerHTML = `
        ...
        <div class="bg-white border rounded-3 p-4" style="opacity:.35">
            <div class="d-flex gap-3">
                <div class="rounded-3 border flex-shrink-0" style="width:48px;height:48px;background:var(--cream)"></div>
                <div class="flex-grow-1 pt-1">
                    <div style="background:#e8eef4;height:14px;width:45%;border-radius:4px;margin-bottom:8px"></div>
                    <div style="background:#e8eef4;height:11px;width:30%;border-radius:4px"></div>
                </div>
            </div>
        </div>
        <div class="bg-white border rounded-3 p-4" style="opacity:.2">
            <div class="d-flex gap-3">
                <div class="rounded-3 border flex-shrink-0" style="width:48px;height:48px;background:var(--cream)"></div>
                <div class="flex-grow-1 pt-1">
                    <div style="background:#e8eef4;height:14px;width:50%;border-radius:4px;margin-bottom:8px"></div>
                    <div style="background:#e8eef4;height:11px;width:40%;border-radius:4px"></div>
                </div>
            </div>
        </div>`;
}
